...
namespace BaseCore.Documents.Implementations.Services
{
    public class BalanceService : IBalanceService
    {
        ...
        public async Task<int> GetBalance(BaseCore.DAL.Implementations.Entities.Product product)
        {
        ...
        public async Task<Balance> Get(BaseCore.DAL.Implementations.Entities.Product product)
        {
            var query = _repository.GetAllAsNotracking()
                .Include(x => x.BalanceEntries)
                .Where(x => x.ProductId == product.Id && x.ZeroDate == null);
